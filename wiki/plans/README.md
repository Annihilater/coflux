...
| [Lift the desktop design system from astryx 0.1.6 to 0.6.0](20260913-astryx-0-6-0.md) | DONE on `dev/20260913-astryx-0-6-0`; not merged, not released; tooltip/menu visual pass on a real machine pending the user | self | None |
| [Restore iOS remote device connectivity on the native Tailcat stack](20260913-ios-tailcat-transport.md) | DONE on `dev/20260913-ios-tailcat-transport` (2026-09-14); not merged, not released; physical-device acceptance pending the user | subagent opus | None; strictly serial milestones — do not fan out |
| [One-shot cross-device command execution under `coflux device`](20260913-device-exec.md) | DONE on `dev/20260913-device-exec` (2026-09-13); not merged, not released; real-machine acceptance needs a deployed server and `cofluxd update` on the target device | subagent opus | None; milestone 1 gates all, milestones 2 and 3 are independent, milestone 4 needs both |
| [Right-edge top-bar menus open at full width again](20260914-right-edge-menu-alignment.md) | DONE on `dev/20260914-right-edge-menu-alignment` (2026-09-14); not merged, not released; visual pass on a real machine pending the user | self | None; single milestone |
| [Restore always-on sidebar device measurement](20260914-sidebar-device-measurement.md) | DONE on `dev/20260914-sidebar-device-measurement` (2026-09-14); not merged, not released; sidebar walkthrough on a real machine pending the user (`pnpm dev:desktop:prod`) | subagent opus | None; single work package, milestones are sequential |
