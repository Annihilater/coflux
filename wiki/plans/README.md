...
| [Restore always-on sidebar device measurement](20260914-sidebar-device-measurement.md) | IN_PROGRESS on `dev/20260914-sidebar-device-measurement` (2026-09-14); plan reviewed and revised via advisor, execution authorized | subagent opus | None; single work package, milestones are sequential |
